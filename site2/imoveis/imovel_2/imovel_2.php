...
$sql = "select tipo from imoveis where id_imovel=2;";
$res = mysqli_query($conn,$sql);
$tipo = mysqli_fetch_object($res);

$sql1 = "select tipologia from imoveis where id_imovel=2;";
$res1 = mysqli_query($conn,$sql1);
$tipologia = mysqli_fetch_object($res1);

$sql2 = "select lotacao from imoveis where id_imovel=2;";
$res2 = mysqli_query($conn,$sql2);
$lotacao = mysqli_fetch_object($res2);

$sql3 = "select preco from imoveis where id_imovel=2;";
$res3 = mysqli_query($conn,$sql3);
$preco = mysqli_fetch_object($res3);

$sql4 = "select localizacao from imoveis where id_imovel=2;";
$res4 = mysqli_query($conn,$sql4);
$local = mysqli_fetch_object($res4);

$sql5 = "select descricao from imoveis where id_imovel=2;";
...
$result = mysqli_query($conn, "SELECT id_imovel FROM reserva WHERE id_imovel = '2';");
?>
...
<body>
    ...
    <div class="topnav" id="myTopnav">
        <a href="/site2/index.html">Home</a>
    ...
    <div class="container">
        <div class="img">
            <img id="img_1" src="https://robinsonplans.com/wp-content/uploads/2015/12/SCOTTSDALE-MISSION-HOME-PLANS-500x500.jpg">
        </div>
        <div class="info">
