...
if(isset($_POST['hospedar'])){
    ...
    $numero_id = $_POST['id4'];
    $nome = $_POST['nome4'];
    $datan_ano = $_POST['ano4'];
    $datan_mes = $_POST['mes4'];
    $datan_dia = $_POST['dia4'];
    $nacionalidade = $_POST['nacio4'];
    $resi_pais = $_POST['resip4'];
    $resi_cidade = $_POST['resic4'];
    $query = "INSERT INTO hospedes (numero_id,nome,data_nascimento,nacionalidade,resi_pais,resi_cidade,id_reserva) VALUES ('$numero_id','$nome','$datan_ano-$datan_mes-$datan_dia','$nacionalidade','$resi_pais','$resi_cidade','$id->id_reserva');";
    $data = mysqli_query ($conn,$query);

    $numero_id = $_POST['id5'];
    $nome = $_POST['nome5'];
    $datan_ano = $_POST['ano5'];
    $datan_mes = $_POST['mes5'];
    $datan_dia = $_POST['dia5'];
    $nacionalidade = $_POST['nacio5'];
    $resi_pais = $_POST['resip5'];
    $resi_cidade = $_POST['resic5'];
    $query = "INSERT INTO hospedes (numero_id,nome,data_nascimento,nacionalidade,resi_pais,resi_cidade,id_reserva) VALUES ('$numero_id','$nome','$datan_ano-$datan_mes-$datan_dia','$nacionalidade','$resi_pais','$resi_cidade','$id->id_reserva');";
    $data = mysqli_query ($conn,$query);
}
...
<body>
    ...
    <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" accept-charset='UTF-8'>
        ...
        Hóspede 4:<br>
        Número de identificação:<br>
        <input type="number" name="id4" min="0" max="999999999">
        Nome:<br>
        <input type="text" name="nome4">
        <br>Data de nascimento:<br>
        <input placeholder="Ano" type="number" name="ano4" min="1900" max="3000">
        <input placeholder="Mês" type="number" name="mes4" min="1" max="12">
        <input placeholder="Dia" type="number" name="dia4" min="1" max="31">
        <br>Nacionalidade:<br>
        <input type="text" name="nacio4">
        <br>País de residência:<br>
        <input type="text" name="resip4">
        <br>Cidade de residência:<br>
        <input type="text" name="resic4">

        Hóspede 5:<br>
        Número de identificação:<br>
        <input type="number" name="id5" min="0" max="999999999">
        Nome:<br>
        <input type="text" name="nome5">
        <br>Data de nascimento:<br>
        <input placeholder="Ano" type="number" name="ano5" min="1900" max="3000">
        <input placeholder="Mês" type="number" name="mes5" min="1" max="12">
        <input placeholder="Dia" type="number" name="dia5" min="1" max="31">
        <br>Nacionalidade:<br>
        <input type="text" name="nacio5">
        <br>País de residência:<br>
        <input type="text" name="resip5">
        <br>Cidade de residência:<br>
        <input type="text" name="resic5">
